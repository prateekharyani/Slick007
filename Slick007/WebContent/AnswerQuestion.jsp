...
<%
  ...
  String customerid = request.getParameter("customerID");
    ...
    if(b)
    {
        ...
        out.println("swal ( 'Message From Server' ,  'Answer Posted Successfully' ,"
                + "  'success' );");
        out.println("});");
        out.println("</script>");
        %>
        <jsp:include page="index_expert.jsp"/>
        <%
    }
    else
    {
    out.println("<script src='https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.11.4/sweetalert2.all.js'></script>");
        ...
        out.println("<script>");
        out.println("$(document).ready(function(){");
        out.println("swal ( 'Message From Server' ,  'Answer not posted !!!' ,"
                + "  'warning' );");
        out.println("});");
        out.println("</script>");
%>
