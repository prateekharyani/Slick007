    ...
    <body>
      <%
          ...
          if(i)
          {
	        ...
	        out.write("setTimeout(function(){window.location.href='index_expert.jsp'},2000);");
	        out.println("});");
	        out.println("</script>");
          }
          else
          {
	        ...
	        out.println("});");
	        out.write("setTimeout(function(){window.location.href='update_profile_expert.jsp'},2000);");
	        out.println("</script>");
         }
         %>
